...
class Net(torch.nn.Module):
    def __init__(self, num_channels=2, upscale_factor=3, d=64, s=12, m=4):
        ...
        # Deconvolution
        self.last_part = nn.ConvTranspose2d(in_channels=d, out_channels=num_channels, kernel_size=9, stride=upscale_factor, padding=3)
